  ...
  return (
    <div className="task-row">
      ...
      <div className="task-main">
        ...
        <input type="checkbox" className="done-checkbox" onChange={handleCompletion}/>
      ...
      <div className="task-actions">
        <button className="edit-btn" onClick={() => setIsTaskModalOpen({ actionTitle : "Update", toOpen : true, payload : task})} ><EditDuotoneIcon height="2em" /></button>
        <button className="delete-btn" onClick={handleDeleteTask}><DeleteLineIcon height="1em" /></button>
      </div>
