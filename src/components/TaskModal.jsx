...
export default function TaskModal({ isTaskModalOpen, handleCloseModal,handleAddTask,handleUpdateTask }) {
    ...
    <div className="modal-overlay">
      <div className="modal-box">
          ...
          <div className="input-row">
            <div className="input-group">
              ...
              <input
                ...
                onChange={(e) => (setTask({...task,deadline_date : e.target.value}))}
              />
            </div>
            ...
            <div className="input-group">
              ...
              <input
                ...
                onChange={(e) => (setTask({...task,deadline_time : e.target.value}))}
              />
            </div>
          </div>
        </div>
        ...
        <div className="modal-footer">
          ...
          <button className="create-btn" onClick={ isTaskModalOpen.payload !== null ? (e) => onTaskUpdation(e) : (e) => onTaskCreation(e)}>
